...
Using FRA's North American Rail Network (NARN) data, create a basic app to calculate mileage between nodes, highlighting rail ownership, calculating rail diversion distance.
